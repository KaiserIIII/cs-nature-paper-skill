...
EXCLUDED_FILES = {"SHA256SUMS.txt", "release_manifest.json", ".ci-smoke-result.json", ".competition-smoke-result.json", ".competition-orchestration-e2e.json", ".full-paper-e2e.json", ".director-orchestration-e2e.json", "resolved_release_manifest.json"}
