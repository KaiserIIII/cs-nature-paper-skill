...
EXCLUDED_DIRS = {".git", ".worktrees", ".research-state", ".research-state-v3", ".research-state-v31", "__pycache__", ".pytest_cache", ".eval", ".security-pressure-run", "runs", "prepared"}
EXCLUDED_FILES = {"SHA256SUMS.txt", "release_manifest.json", ".ci-smoke-result.json", ".competition-smoke-result.json", ".competition-orchestration-e2e.json", ".generic-research-orchestration-e2e.json", ".generic-competition-orchestration-e2e.json", ".host-provider-handoff-e2e.json", ".generic-host-research-e2e.json", ".generic-host-competition-e2e.json", ".full-paper-e2e.json", ".director-orchestration-e2e.json", ".v41-public-core-e2e.json", ".v41-private-ultra-e2e.json", "resolved_release_manifest.json"}
